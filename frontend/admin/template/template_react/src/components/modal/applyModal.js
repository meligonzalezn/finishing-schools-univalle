                ...
                <div className="w-75 modal-dialog modal-dialog-centered justify-content-center w-50" style={{ "transform": "translateX(20%)" }} role="document">
                    <div className="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary" onClick={formik.handleSubmit} disabled={formik.values.email !== '' && formik.values.phone_number !== '' ? false : true}>Aplicar</button>
